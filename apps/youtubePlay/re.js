...
function playV() {
    ...
    if (player == null) {
        ...
        player.loadVideoById({
            videoId: playList[currentPlay],
            startSeconds: playStart[currentPlay],
...
document.addEventListener("DOMContentLoaded", () => {
    document.querySelector('#add').onclick = () => {
        ...
        playStart[playListSize] = Number(document.querySelector('#startTime').value);
        playListSize++;
